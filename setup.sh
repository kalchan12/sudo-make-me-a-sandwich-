...
show_banner() {
    clear
    echo -e "${PURPLE}"
    echo " _______ _______ _____  _______   _______ _______ __  __ _______ "
    echo "|     __|   |   |     \\|       | |   |   |   _   |  |/  |    ___|"
    echo "|__     |   |   |  --  |   -   | |       |       |     <|    ___|"
    echo "|_______|_______|_____/|_______| |__|_|__|___|___|__|\\__|_______|"
    echo "                                                                  "
    echo " _______ _______   _______ "
    echo "|   |   |    ___| |   _   |"
    echo "|       |    ___| |       |"
    echo "|__|_|__|_______| |___|___|"
    echo "                            "
    echo " _______ _______ _______ _____  ________ _______ ______ _______ "
    echo "|     __|   _   |    |  |     \\|  |  |  |_     _|      |   |   |"
    echo "|__     |       |       |  --  |  |  |  |_|   |_|   ---|       |"
    echo "|_______|___|___|__|____|_____/|________|_______|______|___|___|"
    echo -e "${NC}"
